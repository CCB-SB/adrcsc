...
### Load FeatureAblation feature ranking and define feature sets
...
### Train RF model on full TrainV1V2 with different FeatureAblation selections
...
rf_model_scGR_bestconfig <- ranger(y ~ ., data = balanced_train_data[, c(DL_features_scGR_bestconfig, "y")], importance = "impurity")
...
cat("Confusion matrix of top 30 FeatureAblation features RF model on Test1:", "\n")
...
cat("Confusion matrix of top", length(DL_features_scGR_defaultconfig), "(set size from scGR defaultconfig) FeatureAblation features RF model on Test1:", "\n")
cm <- confusionMatrix(predictions, data@y_test, mode = "everything")  
print(cm)
...
cat("Confusion matrix of top", length(DL_features_scGR_bestconfig), "(set size from scGR bestconfig) FeatureAblation features RF model on Test1:", "\n")
cm <- confusionMatrix(predictions, data@y_test, mode = "everything")  
print(cm)
...
cat("Confusion matrix of top 30 FeatureAblation features RF model on Test2:", "\n")
...
cat("Confusion matrix of top", length(DL_features_scGR_defaultconfig), "(set size from scGR defaultconfig) FeatureAblation features RF model on Test2:", "\n")
cm <- confusionMatrix(predictions, y_test2, mode = "everything")  
print(cm)
...
cat("Confusion matrix of top", length(DL_features_scGR_bestconfig), "(set size from scGR bestconfig) FeatureAblation features RF model on Test2:", "\n")
cm <- confusionMatrix(predictions, y_test2, mode = "everything")  
print(cm)
...
start_time <- Sys.time()
knn_model_scGR_bestconfig <- train(y ~ ., data = balanced_train_data[, c(DL_features_scGR_bestconfig, "y")], 
                                   method = "knn", trControl = train_control,
                                   tuneLength = 10)
end_time <- Sys.time()
...
cat("Confusion matrix of top 30 FeatureAblation features kNN model on Test1:", "\n")
...
cat("Confusion matrix of top 30 FeatureAblation features kNN model on Test2:", "\n")
cm <- confusionMatrix(predictions, y_test2, mode = "everything")  
print(cm)
...
cat("Confusion matrix of top", length(DL_features_scGR_defaultconfig), "(set size from scGR defaultconfig) FeatureAblation features kNN model on Test1:", "\n")
cm <- confusionMatrix(knn_predictions, data@y_test, mode = "everything")  
print(cm)
...
cat("Confusion matrix of top", length(DL_features_scGR_defaultconfig), "(set size from scGR defaultconfig) FeatureAblation features kNN model on Test2:", "\n")
...
cat("Confusion matrix of top", length(DL_features_scGR_bestconfig), "(set size from scGR bestconfig) FeatureAblation features kNN model on Test1:", "\n")
cm <- confusionMatrix(knn_predictions, data@y_test, mode = "everything")  
print(cm)
...
cat("Confusion matrix of top", length(DL_features_scGR_bestconfig), "(set size from scGR bestconfig) FeatureAblation features kNN model on Test2:", "\n")
cm <- confusionMatrix(knn_predictions, y_test2, mode = "everything")  
print(cm)
...
cat("Confusion matrix of top 30 FeatureAblation features RF model patient-level predictions on Test2:", "\n")
print(cm_donor_pred)
...
cat("Confusion matrix of top 30 FeatureAblation features kNN model patient-level predictions on Test2:", "\n")
print(cm_donor_pred)
...
cat("Confusion matrix of top", length(DL_features_scGR_defaultconfig), "(set size from scGR defaultconfig) FeatureAblation features RF model patient-level predictions on Test2:", "\n")
print(cm_donor_pred)
...
cat("Confusion matrix of top", length(DL_features_scGR_defaultconfig), "(set size from scGR defaultconfig) FeatureAblation features kNN model patient-level predictions on Test2:", "\n")
print(cm_donor_pred)
...
cat("Confusion matrix of top", length(DL_features_scGR_bestconfig), "(set size from scGR bestconfig) FeatureAblation features RF model patient-level predictions on Test2:", "\n")
print(cm_donor_pred)
...
cat("Confusion matrix of top", length(DL_features_scGR_bestconfig), "(set size from scGR bestconfig) FeatureAblation features kNN model patient-level predictions on Test2:", "\n")
print(cm_donor_pred)
