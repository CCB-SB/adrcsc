...
cat("Confusion matrix of top 30 FeatureAblation features RF model on Test set:", "\n")
...
cat("Confusion matrix of top", length(DL_features_scGR_defaultconfig), "(set size from scGR defaultconfig) FeatureAblation features RF model on Test set:", "\n")
cm <- confusionMatrix(predictions, data@y_test, mode = "everything")  
print(cm)
...
cat("Confusion matrix of top 30 FeatureAblation features kNN model on Test set:", "\n")
...
cat("Confusion matrix of top", length(DL_features_scGR_defaultconfig), "(set size from scGR defaultconfig) FeatureAblation features kNN model on Test set:", "\n")
cm <- confusionMatrix(knn_predictions, data@y_test, mode = "everything")  
print(cm)
...
cat("Confusion matrix of top 30 FeatureAblation features RF model patient-level predictions on Test set", "\n")
print(cm_donor_pred)
...
cat("Confusion matrix of top 30 FeatureAblation features kNN model patient-level predictions on Test set:", "\n")
print(cm_donor_pred)
...
cat("Confusion matrix of top", length(DL_features_scGR_defaultconfig), "(set size from scGR defaultconfig) FeatureAblation features RF model patient-level predictions on Test set:", "\n")
print(cm_donor_pred)
...
cat("Confusion matrix of top", length(DL_features_scGR_defaultconfig), "(set size from scGR defaultconfig) FeatureAblation features kNN model patient-level predictions on Test set:", "\n")
print(cm_donor_pred)
